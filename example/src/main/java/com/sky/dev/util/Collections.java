...
public class Collections {
     ...
     * @implNote This implementation defers to the {@link java.util.List#sort(java.util.Comparator)}
    ...
    public static void shuffle(java.util.List<?> list) {
        java.util.Random rnd = r;
        if (rnd == null)
            r = rnd = new java.util.Random(); // harmless race.
        shuffle(list, rnd);
    }
    ...
    static class UnmodifiableCollection<E> implements java.util.Collection<E>, Serializable {
        ...
        public java.util.Spliterator<E> spliterator() {
            return (java.util.Spliterator<E>) c.spliterator();
        }
     ...
     * @since 1.8
     */
    public static <T> java.util.NavigableSet<T> unmodifiableNavigableSet(java.util.NavigableSet<T> s) {
    ...
    static class UnmodifiableNavigableSet<E>
            ...
            implements java.util.NavigableSet<E>, Serializable {
    ...
    private static class UnmodifiableMap<K, V> implements java.util.Map<K, V>, Serializable {
        ...
        static class UnmodifiableEntrySet<K, V>
            ...
            static final class UnmodifiableEntrySetSpliterator<K, V>
                ...
                final java.util.Spliterator<Entry<K, V>> s;

                UnmodifiableEntrySetSpliterator(java.util.Spliterator<Entry<K, V>> s) {
                    this.s = s;
                }
                ...
                @Override
                public java.util.Spliterator<Entry<K, V>> trySplit() {
                    java.util.Spliterator<Entry<K, V>> split = s.trySplit();
                    return split == null
                            ? null
                ...
                @Override
                public java.util.Comparator<? super Entry<K, V>> getComparator() {
            ...
            public java.util.Spliterator<Entry<K, V>> spliterator() {
                return new UnmodifiableEntrySetSpliterator<>(
                        (java.util.Spliterator<Entry<K, V>>) c.spliterator());
            }
            ...
            private static class UnmodifiableEntry<K, V> implements Entry<K, V> {
                ...
                UnmodifiableEntry(Entry<? extends K, ? extends V> e) {
                    this.e = java.util.Objects.requireNonNull(e);
                }
    ...
    static class UnmodifiableNavigableMap<K, V>
        ...
        private static class EmptyNavigableMap<K, V> extends UnmodifiableNavigableMap<K, V>
            ...
            EmptyNavigableMap() {
                super(new java.util.TreeMap<K, V>());
            }
        ...
        public Entry<K, V> lowerEntry(K key) {
            ...
            return (null != lower)
                    ? new UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(lower)
                    : null;
        }
        ...
        public Entry<K, V> floorEntry(K key) {
            ...
            return (null != floor)
                    ? new UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(floor)
                    : null;
        }
        ...
        public Entry<K, V> ceilingEntry(K key) {
            ...
            return (null != ceiling)
                    ? new UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(ceiling)
                    : null;
        }
        ...
        public Entry<K, V> higherEntry(K key) {
            ...
            return (null != higher)
                    ? new UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(higher)
                    : null;
        }
        ...
        public Entry<K, V> firstEntry() {
            ...
            return (null != first)
                    ? new UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(first)
                    : null;
        }
        ...
        public Entry<K, V> lastEntry() {
            ...
            return (null != last)
                    ? new UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(last)
                    : null;
        }
     ...
     * collection when traversing it via {@link java.util.Iterator}, {@link java.util.Spliterator}
     * or {@link Stream}:
     * <pre>
    ...
    static class SynchronizedCollection<E> implements java.util.Collection<E>, Serializable {
        ...
        SynchronizedCollection(java.util.Collection<E> c) {
            this.c = java.util.Objects.requireNonNull(c);
            mutex = this;
        }

        SynchronizedCollection(java.util.Collection<E> c, Object mutex) {
            this.c = java.util.Objects.requireNonNull(c);
            this.mutex = java.util.Objects.requireNonNull(mutex);
        }
     ...
     * @since 1.8
     */
    public static <T> java.util.NavigableSet<T> synchronizedNavigableSet(java.util.NavigableSet<T> s) {
    ...
    static class SynchronizedNavigableSet<E>
        ...
        SynchronizedNavigableSet(java.util.NavigableSet<E> s, Object mutex) {
            super(s, mutex);
            ns = s;
        }
    ...
    private static class SynchronizedMap<K, V>
        ...
        SynchronizedMap(java.util.Map<K, V> m) {
            this.m = java.util.Objects.requireNonNull(m);
            mutex = this;
        }
    ...
    static class CheckedCollection<E> implements java.util.Collection<E>, Serializable {
        ...
        CheckedCollection(java.util.Collection<E> c, Class<E> type) {
            this.c = java.util.Objects.requireNonNull(c, "c");
     ...
     * @since 1.8
     */
    public static <E> java.util.Queue<E> checkedQueue(java.util.Queue<E> queue, Class<E> type) {
    ...
    static class CheckedQueue<E>
        ...
        CheckedQueue(java.util.Queue<E> queue, Class<E> elementType) {
    ...
    static class CheckedSet<E> extends CheckedCollection<E>
        ...
        CheckedSet(java.util.Set<E> s, Class<E> elementType) {
            super(s, elementType);
        }
     ...
     * @since 1.8
     */
    public static <E> java.util.NavigableSet<E> checkedNavigableSet(java.util.NavigableSet<E> s,
                                                                    Class<E> type) {
    ...
    static class CheckedNavigableSet<E> extends CheckedSortedSet<E>
        ...
        CheckedNavigableSet(java.util.NavigableSet<E> s, Class<E> type) {
            super(s, type);
            ns = s;
        }
    ...
    private static class CheckedMap<K, V>
        ...
        private BiFunction<? super K, ? super V, ? extends V> typeCheck(
            ...
            java.util.Objects.requireNonNull(func);
            return (k, v) -> {
        ...
        CheckedMap(java.util.Map<K, V> m, Class<K> keyType, Class<V> valueType) {
            this.m = java.util.Objects.requireNonNull(m);
            this.keyType = java.util.Objects.requireNonNull(keyType);
            this.valueType = java.util.Objects.requireNonNull(valueType);
        }
     ...
     * previous} always throw {@link java.util.NoSuchElementException}.</li>
    ...
    public static <E> java.util.SortedSet<E> emptySortedSet() {
        return (java.util.SortedSet<E>) UnmodifiableNavigableSet.EMPTY_NAVIGABLE_SET;
    }
     ...
     */
    static <T> java.util.Spliterator<T> singletonSpliterator(final T element) {
        return new java.util.Spliterator<T>() {
            ...
            @Override
            public int characteristics() {
                int value = (element != null) ? java.util.Spliterator.NONNULL : 0;

                return value | java.util.Spliterator.SIZED | java.util.Spliterator.SUBSIZED | java.util.Spliterator.IMMUTABLE |
