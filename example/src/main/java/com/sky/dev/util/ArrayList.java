...
public class ArrayList<E> extends com.sky.dev.util.AbstractList<E>
        implements java.util.List<E>, java.util.RandomAccess, Cloneable, Serializable
{
    ...
    public ArrayList(java.util.Collection<? extends E> c) {
        ...
        if ((size = elementData.length) != 0) {
            ...
            if (elementData.getClass() != Object[].class)
                elementData = com.sky.dev.util.Arrays.copyOf(elementData, size, Object[].class);
        } else {
    ...
    public void trimToSize() {
        ...
        if (size < elementData.length) {
            elementData = (size == 0)
              ? EMPTY_ELEMENTDATA
              : com.sky.dev.util.Arrays.copyOf(elementData, size);
        }
    }
    ...
    private void grow(int minCapacity) {
        ...
        elementData = com.sky.dev.util.Arrays.copyOf(elementData, newCapacity);
    }
    ...
    public Object clone() {
        try {
            ...
            v.elementData = com.sky.dev.util.Arrays.copyOf(elementData, size);
            v.modCount = 0;
            return v;
    ...
    public Object[] toArray() {
        return com.sky.dev.util.Arrays.copyOf(elementData, size);
    }
    ...
    public <T> T[] toArray(T[] a) {
        if (a.length < size)
            ...
            return (T[]) com.sky.dev.util.Arrays.copyOf(elementData, size, a.getClass());
    ...
    private class SubList extends com.sky.dev.util.AbstractList<E> implements RandomAccess {
        private final com.sky.dev.util.AbstractList<E> parent;
    ...
    static final class ArrayListSpliterator<E> implements java.util.Spliterator<E> {
        ...
        public int characteristics() {
            return java.util.Spliterator.ORDERED | java.util.Spliterator.SIZED | Spliterator.SUBSIZED;
        }
    }
    ...
    public boolean removeIf(Predicate<? super E> filter) {
        ...
        int removeCount = 0;
        final java.util.BitSet removeSet = new BitSet(size);
        final int expectedModCount = modCount;
        final int size = this.size;
        for (int i=0; modCount == expectedModCount && i < size; i++) {
            @SuppressWarnings("unchecked")
